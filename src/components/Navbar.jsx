  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        ...
        <button className='hidden md:block bg-white px-8 py-2 rounded'>Sign up</button>
        <img
      ...
      <div
        ...
        <ul className='flex flex-col items-center space-y-2 mt-5 px-5 text-lg font-medium'>
          <a
